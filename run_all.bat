...
echo [1/6] Starting Analytics Service (Port 4242)...
...
echo [2/6] Starting Auth Server (Port 8081)...
start "Auth Server (Port 8081)" powershell -NoExit -Command "cd 'auth-server'; mvn spring-boot:run 2>&1 | Tee-Object -FilePath '..\Logs\auth.log'"

echo [3/6] Starting AI MCP Server (Port 8082)...
...
echo [4/6] Starting AI MCP Client (Port 8083)...
